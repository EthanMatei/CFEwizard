 ...
 *
 */
public class CsvTextFileDisplayAction extends BaseAction implements SessionAware {
	
	private static final long serialVersionUID = 1L;
	private Log log = LogFactory.getLog(CsvTextFileDisplayAction.class);
    ...
    public CsvTextFileDisplayAction() {
        errorMessage    = "";
        fileName        = "";
        fileContentType = "";
        fileStream      = null;
    ...
    public String view() throws Exception {
    	...
    	if (!Authorization.isLoggedIn(session)) {
    		...
    		reportFileName = "Validation mastersheet";
    		...
    		log.info("Displaying CSV text file \"" + textFilePath + "\".");
    	}
