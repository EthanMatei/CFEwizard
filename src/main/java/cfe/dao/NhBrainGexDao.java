...
import cfe.model.NhBrainGex;


public class NhBrainGexDao extends AbstractDao<NhBrainGex>{
	
	public NhBrainGexDao( Session sess, Transaction tx) {
		super(NhBrainGex.class, sess, tx);
	}
