...
import cfe.model.NhBrainMet;

public class NhBrainMetDao  extends AbstractDao<NhBrainMet>{
	
	public NhBrainMetDao( Session sess, Transaction tx) {
		super(NhBrainMet.class, sess, tx);
	}
