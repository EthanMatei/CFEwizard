...
import cfe.model.prioritization.HuBrainMet;

public class HuBrainMetDao  extends AbstractDao<HuBrainMet>{

	public HuBrainMetDao( Session sess, Transaction tx) {
		super(HuBrainMet.class, sess, tx);
	}
