...
import cfe.model.prioritization.HuGeneCNV;

public class HuGeneCNVDao extends AbstractDao<HuGeneCNV>{
	
	public HuGeneCNVDao( Session sess, Transaction tx) {
		super(HuGeneCNV.class, sess, tx);
	}
