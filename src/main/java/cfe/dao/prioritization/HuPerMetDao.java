...
import cfe.model.prioritization.HuPerMet;

public class HuPerMetDao extends AbstractDao<HuPerMet> {
		
	public HuPerMetDao( Session sess, Transaction tx) {
		super(HuPerMet.class, sess, tx);
	}
