...
import cfg.model.HuBrainProt;


public class HuBrainProtDao  extends AbstractDao<HuBrainProt>{

	public HuBrainProtDao( Session sess, Transaction tx) {
		super(HuBrainProt.class, sess, tx);
	}
