...
import cfg.model.HuGeneLinkage;

public class HuGeneLinkageDao extends AbstractDao<HuGeneLinkage> {
	
	public HuGeneLinkageDao( Session sess, Transaction tx) {
		super(HuGeneLinkage.class, sess, tx);
	}
