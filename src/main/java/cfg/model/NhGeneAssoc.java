...
@Entity
@Table(name=TblNames.NH_GENE_ASSOC)
public class NhGeneAssoc extends Model implements ModelInterface, Serializable {

	private static final long serialVersionUID = 186929775777388383L;
