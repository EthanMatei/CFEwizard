...
import cfg.model.disease.Disease;
import cfg.model.disease.DiseaseSelection;
import cfg.model.disease.DiseaseSelector;
import cfg.model.results.CategoryResult;
import cfg.model.results.Result;
import cfg.model.results.Results;
import cfg.services.HuBrainGexService;
import cfg.services.HuBrainMetService;
import cfg.services.HuBrainProtService;
import cfg.services.HuGeneAssocService;
import cfg.services.HuGeneCNVService;
import cfg.services.HuGeneLinkageService;
import cfg.services.HuPerGexService;
import cfg.services.HuPerMetService;
import cfg.services.HuPerProtService;
import cfg.services.NhBrainGexService;
import cfg.services.NhBrainMetService;
import cfg.services.NhBrainProtService;
import cfg.services.NhGeneAssocService;
import cfg.services.NhGeneCNVService;
import cfg.services.NhGeneLinkageService;
import cfg.services.NhPerGexService;
import cfg.services.NhPerMetService;
import cfg.services.NhPerProtService;
...
public class Score {
	...
	public static Results calculate(GeneListInput geneListInput, DiseaseSelection diseaseSelection, List<cfg.enums.ScoringWeights> weights) 
	        throws Exception {
		...
		for (cfg.enums.ScoringWeights weight: weights) {
			switch (weight) {
			case HUBRAIN:
