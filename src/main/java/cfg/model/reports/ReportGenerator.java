...
import cfg.model.VersionNumber;
...
public class ReportGenerator {
	 ...
	 */
	public static InputStream generate(String reportName, String reportFormat, Results results, Map<String, ScoreResults> scores, List<cfg.enums.ScoringWeights> weights, List<DiseaseSelector> diseaseSelectors) throws ReportException {
	 ...
	 * @return an InputStream for the generated spreadsheet.
	 */
	private static InputStream generateScoresReport(String reportFormat, Results results, Map<String, ScoreResults> scores, List<cfg.enums.ScoringWeights> weights, List<DiseaseSelector> diseaseSelectors) {
	...
	private static ReportSheet getScoringWeightsSheet(String reportFormat, List<cfg.enums.ScoringWeights> weights) {
