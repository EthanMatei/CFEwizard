...
import cfg.utils.ParseResult;
import cfg.utils.TableParseResult;
import cfg.utils.Util;
...
public class MSAccessParser implements IParser {
	...
	public void parse(String filename) throws Exception {
		...
		for (String tablename : tablenames)	{
			...
			try {
				...
				if (tablename.contains(cfg.enums.Tables.HU_BRAIN_GEX.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_BRAIN_GEX.getTblName());
					hbgDao.saveAll(hbgs);

					// tblnames.add(cfg.enums.Tables.HU_BRAIN_GEX.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.HU_BRAIN_MET.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_BRAIN_MET.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_BRAIN_MET.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.HU_BRAIN_PROT.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_BRAIN_PROT.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_BRAIN_PROT.getClassname());

					/************************ End HUBRAIN TABLES *******************************/

					/************************ Begin HUGENE TABLES ******************************/
				} else if (tablename.contains(cfg.enums.Tables.HU_GENE_ASSOC.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_GENE_ASSOC.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_GENE_ASSOC.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.HU_GENE_CNV.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_GENE_CNV.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_GENE_CNV.getClassname());
				}

				/**
				 * Disable Linkage for now else if
				 * (tablename.contains(cfg.enums.Tables.HU_GENE_LINKAGE.getLabel())) {
				 ...
				 * hbgDao.deleteAll(cfg.enums.Tables.HU_GENE_LINKAGE.getTblName());
				 * hbgDao.saveAll(hbps);
				 * //tblnames.add(cfg.enums.Tables.HU_GENE_LINKAGE.getClassname());
				 * 
				 * /* *********************** End HUGENE TABLES ****************************** *
				 * /
				 * 
				 ...
				 * / }
				 */
				else if (tablename.contains(cfg.enums.Tables.HU_PER_GEX.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_PER_GEX.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_PER_GEX.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.HU_PER_MET.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_PER_MET.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_PER_MET.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.HU_PER_PROT.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.HU_PER_PROT.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.HU_PER_PROT.getClassname());

					/************************ End HUPER TABLES ***********************************/

					/************************ Begin NHBRAIN TABLES *******************************/
				} else if (tablename.contains(cfg.enums.Tables.NH_BRAIN_GEX.getLabel())) {
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_BRAIN_GEX.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_BRAIN_GEX.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.NH_BRAIN_MET.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_BRAIN_MET.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_BRAIN_MET.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.NH_BRAIN_PROT.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_BRAIN_PROT.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_BRAIN_PROT.getClassname());
					/************************ END NHBRAIN TABLES *******************************/

				} else if (tablename.contains(cfg.enums.Tables.NH_GENE_ASSOC.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_GENE_ASSOC.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_GENE_ASSOC.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.NH_GENE_CNV.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_GENE_CNV.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_GENE_CNV.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.NH_PER_MET.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_PER_MET.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_PER_MET.getClassname());

					/************************ END NHBRAIN TABLES *******************************/
				} else if (tablename.contains(cfg.enums.Tables.NH_PER_PROT.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_PER_PROT.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_PER_PROT.getClassname());

				} else if (tablename.contains(cfg.enums.Tables.NH_PER_GEX.getLabel())) {
					// DateAdded in the ms access is TEXT. Need to change to date
					...
					hbgDao.deleteAll(cfg.enums.Tables.NH_PER_GEX.getTblName());
					hbgDao.saveAll(entities);
					// tblnames.add(cfg.enums.Tables.NH_PER_GEX.getClassname());
				} else {
	...
	/*
	public <T> List<T> parseTable(Database db, String tablename, cfg.enums.Tables table, Session session) {
