	...
	private static SessionFactory buildSessionFactory() {
		...
		try {
			...
			Class<?>[] models = {
					...
					cfg.model.DatabaseUploadInfo.class,
					cfg.model.Disorder.class,
					
					// Human Brain Database contains these three tables
					cfg.model.HuBrainGex.class , 
					cfg.model.HuBrainProt.class, 
					cfg.model.HuBrainMet.class,
					
					// Human Gene Database contains these three tables
					cfg.model.HuGeneCNV.class,
					cfg.model.HuGeneAssoc.class,
					cfg.model.HuGeneLinkage.class,
					
					// Human Per Database contains these three tables
					cfg.model.HuPerGex.class,
					cfg.model.HuPerProt.class, 
					cfg.model.HuPerMet.class,
					
					
					// Non Human Brain Database contains these three tables
					cfg.model.NhBrainGex.class, 
					cfg.model.NhBrainProt.class, 
					cfg.model.NhBrainMet.class, 
									
					// Non Human Per Database contains these three tables
					cfg.model.NhPerGex.class,
					cfg.model.NhPerProt.class,
					cfg.model.NhPerMet.class,
					
					cfg.model.NhGeneCNV.class,
					cfg.model.NhGeneAssoc.class,
					cfg.model.NhGeneLinkage.class,
					
					// Gene list
					cfg.model.GeneList.class,
					
					// Summary data
					cfg.model.ScoringData.class										
					};
