...
d <- "Z:\\Delusions2021\\Mariah Project Folder\\Validation\\Delusion Validation Mastersheet (MDH 4-14-2021).csv"
...
predictorFilePath <- "Z:\\Delusions2021\\Mariah Project Folder\\Validation\\DelusionPredictorList (MDH 4-14-2021).csv"  #current way we're doing it for now

#predictorFilePath <- "Z:\\Pain Project 4-21-17\\DFL Predictions\\predictorListBioM22.csv"

#predictorFilePath <- "Z:\\Pain Project 4-21-17\\DFL Predictions\\predictorListBioM1.csv"

#predictorFilePath <- "Z:\\Pain Project 4-21-17\\DFL Predictions\\predictorListBioM22PanelOnly.csv"
...
# cutoff <- 4 #greater than or equal to cutoff for PHENE
...
csvOutputFolder <- "Z:\\Delusions2021\\Mariah Project Folder\\R Outputs\\Validation"
...
for (i in 1:(nrow(predictors))) {
  ...
  source("Z:\\Psychosis2020\\OKM R Files\\CurrentBatchFunctionFourCornerstones (PLP 5-3-17).R")
