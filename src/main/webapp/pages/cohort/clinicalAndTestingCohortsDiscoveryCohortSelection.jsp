...
<tiles:putAttribute name="header">
    <title>CFE Wizard - Clinical and Testing Cohorts - Discovery Cohort Selection</title>
    <s:head />
...
<h2>Clinical and Testing Cohorts - Discovery Cohort Selection</h2>
...
<s:form action="ClinicalAndTestingCohortsSpecification" theme="simple">
